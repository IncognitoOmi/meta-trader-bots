...
# Dictionary of timeframes to iterate over
timeframes = {
    "1 Minute": mt5.TIMEFRAME_M1,
    "2 Minute": mt5.TIMEFRAME_M2,
    "3 Minute": mt5.TIMEFRAME_M3,
    "4 Minute": mt5.TIMEFRAME_M4,
    "5 Minute": mt5.TIMEFRAME_M5,
    "15 Minute": mt5.TIMEFRAME_M15,
    "30 Minute": mt5.TIMEFRAME_M30,
    "10 Minute": mt5.TIMEFRAME_M10
}
...
# ==========================================
# 📊 2 & 3. LOOP OVER ALL TIMEFRAMES
# ==========================================
for tf_name, timeframe_val in timeframes.items():
    print(f"\n\n{'='*150}")
    print(f"🚀 STARTING BACKTEST FOR TIMEFRAME: {tf_name}")
    print(f"{'='*150}")
    ...
    # Reset variables for each timeframe
    tp_hits, sl_hits = 0, 0
    total_pnl = 0.0 
    ...
    print("-" * 150)
    print(f"📊 {tf_name} SUMMARY | {MAX_LAYERS}-Layer Grid Mode | Dynamic Lot ({RISK_MULT} Mult) | Filters Active")
    print("-" * 150)
