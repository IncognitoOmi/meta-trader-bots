...
MAGIC_NUMBER = 704513368 
account_login = 86116568
account_password = "Sanjay@1965"
broker_server = "XMGlobal-MT5 4"

if not mt5.initialize(path = "C:/Program Files/MetaTrader 5 - XM/terminal64.exe") or not mt5.login(login=account_login, password=account_password, server=broker_server):
    print("❌ MT5 Connection Fail!")
    quit()
print(f"✅ Bot ACTIVE 🦅 | XM MODE ON \n")
