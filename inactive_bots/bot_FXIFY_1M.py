...
broker_server = "FXPIG-Server"

if not mt5.initialize(path="C:/Program Files/MetaTrader 5 - FXIFY_1m/terminal64.exe") or not mt5.login(login=account_login, password=account_password, server=broker_server):
    print("❌ MT5 Connection Fail!")
    quit()
print(f"✅ Bot ACTIVE | FXIFY 🦅\n")
...
# def get_dynamic_lot(symbol, atr):
#     if symbol in ["EURUSD", "AUDUSD", "GBPUSD"]:
#         if atr <= 0.0001: return 9
#         elif 0.0001 < atr <= 0.00015: return 8
#         else: return 7
#     else:
#         if atr <= 5.0: return 0.6
#         elif 5.0 < atr <= 10.0: return 0.6
#         else: return 0.6
